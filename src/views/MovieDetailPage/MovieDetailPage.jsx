            ...
            <section className={s.movieDetails}>
                ...
                <div className={s.movieBox}>
                    <div className={s.imageBox}>
                        <img
                            src={
                                movieDetails.poster_path ? `https://image.tmdb.org/t/p/w300${movieDetails.poster_path}` : `https://cdn.pixabay.com/photo/2016/03/31/18/36/cinima-1294496_1280.png`
                            }
                    ...
                    <div className={s.infoBox}>
                        ...
                        <p className={s.userScore}>{`User Score: ${movieDetails.vote_average * 10}%`}</p>
